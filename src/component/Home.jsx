...
const Home = () => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Why Choose Sagar Garrie?
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Experience the perfect blend of authentic flavors, warm hospitality, and exceptional service
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Every dish is crafted with passion and care, ensuring that each bite delivers an unforgettable experience.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Our friendly staff ensures that every guest feels welcomed and valued throughout their dining experience.
              </p>
            </div>
          </div>
        </div>
  ...
  <div className="hero-buttons">
    <a href="/book-table" className="hero-btn-primary">
      Book Your Table
    </a>
