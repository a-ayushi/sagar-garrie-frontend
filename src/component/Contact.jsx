  ...
  const contactInfo = [
    {
      ...
      title: 'Address',
      details: '123 Main Street, Downtown District, City 12345'
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="min-h-screen bg-gradient-to-br from-primary-50 to-primary-100 flex items-center justify-center px-4">
        <div className="max-w-md w-full bg-white rounded-lg shadow-xl p-8 text-center">
          ...
          <p className="text-sm text-gray-500">
            We appreciate your interest in Sagar Garrie!
          </p>
        </div>
      </div>
    );
          ...
          <div className="contact-info-section">
            <div className="contact-info-header">
              ...
              <p className="contact-info-description">
                Whether you have questions about our menu, want to make a reservation, or have feedback about your dining experience, we're here to help.
              </p>
            </div>
            ...
            <div className="social-media-section">
              ...
              <div className="social-media-links">
                <a href="#" className="social-media-link facebook">
                ...
                <a href="#" className="social-media-link instagram">
                  <svg className="social-icon" fill="currentColor" viewBox="0 0 24 24">
